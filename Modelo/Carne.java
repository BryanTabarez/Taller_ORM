...
public class Carne implements Serializable {
    ...
    public Carne(Integer carneId, int ingredienteId, String nombre, String precioporcion, int cantidad, String tipo, String presentacion, String cantidadgrasas, String animal) {
        this.carneId = carneId;
    ...
    public String getCantidadgrasas() {
        return cantidadgrasas;
    }

    public void setCantidadgrasas(String cantidadgrasas) {
        this.cantidadgrasas = cantidadgrasas;
    }
    ...
    public String toString() {
        return "Modelo.Carne[ carneId=" + carneId + " ]";
    }
